...
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { SD_DAT[3] }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]		 
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { SD_CMD }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]         
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { SD_DAT[0] }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]        
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33     } [get_ports { SD_CLK }]; #IO_L11N_T1_SRCC_13 Sch=jb_n[2]        
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33     } [get_ports { SD_DAT[1] }]; #IO_L13P_T2_MRCC_13 Sch=jb_p[3]        
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33     } [get_ports { SD_DAT[2] }]; #IO_L13N_T2_MRCC_13 Sch=jb_n[3]        
...
##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { BUS_MOSI }]; #IO_L10P_T1_34 Sch=jc_p[1]   			 
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { BUS_MISO }]; #IO_L10N_T1_34 Sch=jc_n[1]		     
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { BUS_SCLK }]; #IO_L1P_T0_34 Sch=jc_p[2]              
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { PSRAM_SS }]; #IO_L1N_T0_34 Sch=jc_n[2]              
...
##Pmod Header JE - NOTE: This is the only Pmod port on the board with 200 ohm resistor outputs - 
# these prevents shorts when input signals are accidentally driven as outputs (according to the manual)                                                                                            
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { A_OUT }]; #IO_L4P_T0_34 Sch=je[1]						 
...
#create_clock -add -name spi_clk_pin -period 200.0 -waveform {0 100} [get_ports { SCLK }];
                         
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { je[3] }]; #IO_L19P_T3_35 Sch=je[4]                     
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { SS }]; #IO_L3N_T0_DQS_34 Sch=je[7]                  
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { MOSI }]; #IO_L9N_T1_DQS_34 Sch=je[8]                  
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { MISO }]; #IO_L20P_T3_34 Sch=je[9]                     
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { SCLK }]; #IO_L7N_T1_34 Sch=je[10]                    
 set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets SCLK_IBUF]                
create_clock -add -name spi_clk -period 200.00 -waveform {0 100} [get_ports { SCLK }];
create_clock -add -name sd_clk -period 20.00 -waveform {0 10} [get_nets { SD_CLK }];
